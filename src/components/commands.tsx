...
const Commands: React.FC<ICommandProps> = ({ commands }) => {
    ...
    return <div className="m-0 p-8 min-w-[250px] max-w-[250px] overflow-y-auto rounded max-h-[calc(33vw+2rem)]">
        <p className="break-word pb-4 font-semibold whitespace-pre-wrap text-white">Available Commands</p>
