...
move();`,
        commands: ["move", "turnLeft", "putBeeper", "pickBeeper", "leftIsClear"],
        worlds: [
            {
                walls: [
                    [0, 0, 0, 0, 13],
...
move();`,
    ...
    {
        name: "Corridors Zig Zag 2 - Else/ Else If",
        ...
        <b>Verschiedene Bedingungen</b><br>
        Es kann ganz verschiedene Bedingungen geben, die wir abfragen können. Mit beeperIsPresent() können wir abfragen, ob Pfeili sich auf einem Beeper befindet. Es wird genauso in die runden Klammern nach dem if() eingesetzt, wie frontIsBlocked()<br><br>`,
